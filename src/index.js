        ...
        <div className={"displayed-card theme-" + window.theme}>
          ...
          <div className="displayed-card-footer">
            <div className="displayed-card-created">
              ...
              <span className="displayed-card-creator">{window.users[this.props.creator].name} <span>created this card on</span> {this.props.creation_date}</span>
            </div>
          </div>
        </div>
      </div>
...
var boardContainer = 
            <div>
              ...
              <DisplayedCard name="Call a function from its name/id in order to allow arrays of functions." description={"Add an option to call functions from its name/id for more flexibility, specifically to make lists of functions. Alternatively make some kind of function object."} column={1} tags={[0, 1, 4]} assignees={[1, 3]}/>
            </div>;
